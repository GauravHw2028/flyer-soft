...
3. The hosted pilot remains private to its owner. Invite intended customers through hosting access settings before onboarding them; the app's business email assignment does not itself grant hosting access. A broadly sold SaaS will need its own onboarding and account-management experience. This pilot uses ChatGPT sign-in and one login per business; team seats and self-service subscriptions are not implemented.
